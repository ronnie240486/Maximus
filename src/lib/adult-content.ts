...
// Bloqueio global por título: alguns painéis não marcam corretamente a categoria.
// A lista é aplicada apenas para impedir conteúdo adulto no catálogo do aplicativo.
const ADULT_TITLE_RE = /(?:^|[^a-z0-9])(?:xxx|adulto|adult|porn|porno|pornografia|sexo|sex|erotic|erotico|erotica|18\+|\+18|nsfw|nude|nudity|hardcore|fetish|hentai|anal|boquete|prostitu|onlyfans|only fans|playboy|sexy|brasileirinhas|brasileirinha|novinha|novinhas|ninfeta|ninfetas|putaria|pelada|peladas|safada|safadas|vazadas|vazado|amadoras|amadora)(?:$|[^a-z0-9])/i;
