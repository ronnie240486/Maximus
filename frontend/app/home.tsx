...
export default function HomeScreen() {
  ...
  const allNavItems = [
    ...
    { key: 'world-cameras', label: 'Mundo', testID: 'nav-world-cameras', icon: (active: boolean) => <Ionicons name="earth" size={navIconSize} color={active ? colors.accentCyan : colors.textSecondary} />, onPress: () => router.push('/world-cameras') },
